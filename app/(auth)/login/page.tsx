        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-sm font-medium" style={{ color: 'rgba(242,229,197,0.85)' }}>Password</label>
              <Link href="/forgot-password" className="text-xs transition"
                style={{ color: 'rgba(242,229,197,0.55)' }}>
                Forgot password?
              </Link>
            </div>
